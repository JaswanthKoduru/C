...
int main()
{
	...
	printf("\t\t\t"
	">>>> Hello!!! This is a program compiles all the C Basics <<<<\n\n\t\t\t\t     "
	">>>> What would you like to do? <<<<");
 	...
 	char repeat;
	 	...
	 	do{
			...
			switch(choice)
			{
				...
				case 1:
				{
					...
					switch(ch16)
					{
						...
						case 4:
							printf("\nIdentifiers are user defined words, they are the names given to the entities like variables, arrays, functions etc...\nexample : int a,float b,char c");
							break;
				...
				case 2:
				{
					...
					switch(ch1)
					{
						...
						case 8:
							...
							printf("\nThe sum of cube of digits of is %d",sum);
				...
				case 3:
				{
					...
					{
						case 1:
							printf("\nThere are four types of function declarations.\nPlease select one: ");
							...
							case 3:
								...
								printf("\n\n\n1. fibonacci series(i.e with recursion)\n2. fibonacci series(i.e without recursion)");
								int ch6;
								printf("\nEnter your choice");
								scanf("%d",&ch6);
								switch(ch6)
							...
							switch(ch8)
							{
								...
								case 2:
									...
									case 4:
										...
										case 7:
											printf("\nEnter the 5 array elements to sort them in ascending order");
											for(i=0;i<5;i++)
												scanf("%d",&arr[i]);
								...
								case 2:printf("\n1. Null Pointer\n2. Wild Pointer\n3. Dangling Pointer\n4. Void Pointer\n5> Type casting\n6. Addition using pointers\n7. Example program on pointers");
									...
									switch(ch15)
									{
										...
										case 7:
											int *pt1,*pt2,*pt3,*pt4,x,y,z,m,n,val,def;
											i=10,j=2;
											a=10;
											b=3;
											pt3=&a;
			...
			//SELECTING A CHOICE(Repeat or not)
			
			printf("\n\n\nWould you like to search for another topic(y/yes/n/no): ");
			scanf("%s",&repeat);
			if(repeat=='y')
				system("CLS");
				
		  }while(repeat=='y');//Repeat the process when the user chooses yes
